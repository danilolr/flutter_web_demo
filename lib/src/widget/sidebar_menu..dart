              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image:
                          NetworkImage("https://backgrounddownload.com/wp-content/uploads/2018/09/google-material-design-background-6.jpg"),
                      fit: BoxFit.cover,
                    )),
                child: Container(
                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          (_animation.value >= 250) ? Text("Yasin ilhan", style: menuListTileDefaultText) : Container(),
                        ],
                      ),
                      SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return MenuItemTile(
                      ...
                      codigo: menuItems[index].codigo,
                      onTap: () {
                        final MenuBloc menuBloc = BlocProvider.getBloc<MenuBloc>();
                        menuBloc.alteraOpcaoMenu(menuItems[index].codigo);
                        setState(() {
                          selectedIndex = index;
                        });
                      },
